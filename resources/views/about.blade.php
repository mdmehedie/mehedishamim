...
@section('content')
    <div class="experience my-5" id="experience" style="background-color: #4db99a; background-image: url(assets/edgetop01.png),url(assets/edgebottom02.png); background-position: top,bottom; background-repeat:no-repeat, repeat-x,repeat-y;">
        <div class="container">
            <header class="section-header text-center wow zoomIn mb-5" data-wow-delay="0.1s">
                <p>My Resume</p>
            ...
            <div class="timeline" >
                <div class="timeline-item left wow slideInLeft" data-wow-delay="0.1s">
                    <div class="timeline-text">
                        ...
                        <h2 class="text-right">Web Developer</h2>
                        <h4 class="text-right">Texon Limited, Gazipur</h4>
                        <p class="text-right">
