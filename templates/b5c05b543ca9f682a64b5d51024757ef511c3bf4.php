...
<?php $__env->startSection('content'); ?>
    ...
    <div class="experience my-5" id="experience" style="color: white; background-color: #0D1455; background-image: url(<?php echo e(asset('assets/edgetop01.png')); ?>), url(<?php echo e(asset('assets/edgebottom02.png')); ?>); background-position: top,bottom; background-repeat:no-repeat, repeat-x,repeat-y;">
        <div class="container ">
            <div class="timeline">
                <div class="timeline-item left wow slideInLeft" data-wow-delay="0.1s">
                    <div class="timeline-text">
