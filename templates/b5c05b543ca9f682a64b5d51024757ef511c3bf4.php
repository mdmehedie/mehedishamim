...
<?php $__env->startSection('content'); ?>
    <div class="container my-5">
        <div class="row">
            <div class="col-md-12 col-sm-12 d-flex align-items-end border-bottom pt-5" >
                ...
                <div>
                    <img src="<?php echo e(asset('assets/Mehedi-shamim.png')); ?>" class="wow slideInLeft" style="top:0; right:0;">
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="experience my-5" id="experience" style="background-color: #4bc1c4; background-image: url(<?php echo e(asset('assets/edgetop01.png')); ?>), url(<?php echo e(asset('assets/edgebottom02.png')); ?>); background-position: top,bottom; background-repeat:no-repeat, repeat-x,repeat-y;">
        <div class="container ">
            <div class="timeline">
                <div class="timeline-item left wow slideInLeft" data-wow-delay="0.1s">
                    <div class="timeline-text">
            ...
            <div class="timeline" >
                <div class="timeline-item left wow slideInLeft" data-wow-delay="0.1s">
                    <div class="timeline-text">
                        ...
                        <img src="<?php echo e(asset('assets/the_daily_bislesion.jpg')); ?>" class="timeline-img" width="30%">
                ...
                <div class="timeline-item right wow slideInRight" data-wow-delay="0.1s">
                    <div class="timeline-text">
                        ...
                        <img src="<?php echo e(asset('assets/tib.jpeg')); ?>" class="timeline-img" width="60%">
                        <h2>TIB Journey</h2>
    ...
    <div class="experience my-5" id="experience" style="background-color: #4bc1c4; background-image: url(<?php echo e(asset('assets/edgetop02.png')); ?>), url(<?php echo e(asset('assets/edgebottom01.png')); ?>); background-position: top,bottom; background-repeat:no-repeat, repeat-x,repeat-y;">
        <div class="container ">
            <div class="timeline">
                <div class="timeline-item left wow slideInLeft" data-wow-delay="0.1s">
                    <div class="timeline-text">
                        <div class="timeline-date">2013</div>
                        <img src="<?php echo e(asset('assets/project natun jama.jpeg')); ?>" class="timeline-img" width="80%">
                ...
                <div class="timeline-item right wow slideInRight" data-wow-delay="0.1s">
                    <div class="timeline-text">
                        ...
                        <img src="<?php echo e(asset('assets/bodher_breaking_news.jpg')); ?>" class="timeline-img" width="40%">
                ...
                <div class="timeline-item left wow slideInLeft" data-wow-delay="0.1s">
                    <div class="timeline-text">
                        ...
                        <img src="<?php echo e(asset('assets/Team Spice.jpeg')); ?>" class="timeline-img" width="280px">
                        <h2>96.4 Spice FM </h2>
                        <h4>Full time Job</h4>
                        <p>
            ...
            <div class="timeline" >
                ...
                <div class="timeline-item left wow slideInLeft" data-wow-delay="0.1s">
                    <div class="timeline-text">
                        ...
                        <img src="<?php echo e(asset('assets/wife.jpg')); ?>" class="timeline-img p-0 background-none" width="40%" >
                        <img src="<?php echo e(asset('assets/tolpitolpar_golpo.JPG')); ?>" class="timeline-img-text-side" width="220px" >
                        <img src="<?php echo e(asset('assets/summit.jpeg')); ?>" class="timeline-img-side p-0 background-none" width="45%">
                ...
                <div class="timeline-item right wow slideInRight" data-wow-delay="0.1s">
                    <div class="timeline-text">
                        ...
                        <img src="<?php echo e(asset('assets/walton.jpg')); ?>" class=" timeline-img p-0 background-none text-left background-none" style="top: 2rem; box-shadow: 0 0 0; right: calc(100% + 80px);" width="40%" >
                        <h2>Walton</h2>
                ...
                <div class="timeline-item left wow slideInRight" data-wow-delay="0.1s">
                    <div class="timeline-text">
                        ...
                        <img src="<?php echo e(asset('assets/tailor.jpeg')); ?>" class=" timeline-img p-0 background-none text-right background-none" style="box-shadow: 2px 2px 6px 1px rgba(83, 83, 83, 0.1); " width="60%" >
                ...
                <div class="timeline-item right wow slideInRight" data-wow-delay="0.1s">
                    <div class="timeline-text">
                        <div class="timeline-date">2020</div>
                        <img src="<?php echo e(asset('assets/Jo-bike.jpg')); ?>" class="timeline-img p-0 background-none" width="40%" >
                ...
                <div class="timeline-item left wow slideInRight" data-wow-delay="0.1s">
                    <div class="timeline-text">
                        <div class="timeline-date">2020</div>
                        <img src="<?php echo e(asset('assets/abdul_momen.jpg')); ?>" class="timeline-img p-0 background-none" width="300px" style="box-shadow: 2px 2px 6px 1px rgba(83, 83, 83, 0.1);" >
