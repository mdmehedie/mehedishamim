<?php $__env->startSection('page_title', $dataType->getTranslatedAttribute('display_name_plural')); ?>

<?php $__env->startSection('page_header'); ?>
    <h1 class="page-title">
        <i class="voyager-list"></i><?php echo e($dataType->getTranslatedAttribute('display_name_plural')); ?>
                                    ...
                                    <li class="dd-item" data-id="<?php echo e($result->getKey()); ?>">
                                        <div class="dd-handle" style="height:inherit">
                                            ...
                                            <?php elseif($dataRow->type == 'image'): ?>
                                                <span>
                                            <img
                                                src="<?php if( !filter_var($result->{$display_column}, FILTER_VALIDATE_URL)): ?><?php echo e(Voyager::image( $result->{$display_column} )); ?><?php else: ?><?php echo e($result->{$display_column}); ?><?php endif; ?>"
                                                style="height:100px">
                                        </span>
                                            <?php else: ?>
                                                <?php
...
<?php echo $__env->make('voyager::master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/tailydcr/texon.mehedishamim.com_/resources/views/vendor/voyager/home-category-orders/order.blade.php ENDPATH**/ ?>