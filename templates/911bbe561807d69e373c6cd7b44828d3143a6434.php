...
<nav class="navbar navbar-expand-lg navbar-light sticky-top bg-white">
    <div class="container">
        ...
        <a class="navbar-brand logo-image pb-2" href="<?php echo e(route('home')); ?>">
            <img class="img-fluid" src="<?php echo e(asset('assets/logo.jpg')); ?>" alt="alternative"/>
        </a>
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item py-3" href="#">Book</a>

                        <div class="dropdown-divider m-0"></div>
                        <a class="dropdown-item py-3" href="#">Poem</a>
                        <div class="dropdown-divider m-0"></div>
                        <a class="dropdown-item py-3" href="#">Short Stories</a>
                    </div>
                </li>
...
<?php /**PATH /Users/shuvo./Documents/MehediSamimProfile/resources/views/shared/navbar.blade.php ENDPATH**/ ?>